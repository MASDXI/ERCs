...
author: sirawt (@MASDXI), Sirawit Techavanitch (sirawit_tec@live4.utcc.ac.th), Supache Innet (supachate_inn@utcc.ac.th)
...
interface IERC8047 /**is IERC1155, IERC5615 */ {
    ...
    /**
    * @notice Returns the total value of all tokens currently in circulation.
    * Burned tokens, having a value of zero, do not contribute to the total supply.
...
levels bucket _ 256 to (bucket + 1) _ 256 - 1.
