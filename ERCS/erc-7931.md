...
Receive addresses that participated in the vote in the Governance contract and the Executor's address.
...
[ERC-712](./eip-712.md) can also be used for Executor verification.
